...
\textwidth 6.5in \textheight 11in \hoffset -0.30in \topmargin -0.45in
...
%This is the standard normal Z table. The cells contain values which correspond to the area under the curve of the standard normal density function to the left of the point given by the row and column. For example, the area to the left of 1.96 is .9750.
